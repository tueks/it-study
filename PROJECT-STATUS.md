...
| Estado del registro | B001–B028 `closed`; B029 autorizado pero requiere inventario exacto de rutas; B033–B042 inactivos. |
...
Autorizar un inventario B029 exacto de dos rutas de aprendizaje, con IDs, audiencia, objetivo, entradas, prerrequisitos, checkpoints y fuentes; después, Codex podrá preparar B029 d1.
...
- B029 requiere un inventario exacto de dos rutas de aprendizaje; no se seleccionan audiencias, secuencias ni checkpoints por inferencia.
