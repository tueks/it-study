...
| Estado del registro | B001–B029 `closed`; B030 autorizado pero requiere inventario exacto de rutas; B033–B042 inactivos. |
...
Autorizar un inventario B030 exacto de una o dos rutas de aprendizaje, con IDs, audiencia, objetivo, entradas, prerrequisitos, checkpoints y fuentes; después, Codex podrá preparar B030 d1.
...
- B030 requiere un inventario exacto de rutas de aprendizaje; no se seleccionan audiencias, secuencias ni checkpoints por inferencia.
