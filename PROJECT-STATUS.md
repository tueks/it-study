...
| Estado del registro | B001–B027 `closed`; B028 `in-review` con inventario autorizado; B033–B042 inactivos. |
...
Obtener la aceptación editorial de B028 d1; después, promover, integrar, validar, reconciliar y cerrar sus dos escenarios automáticamente.
...
- B028 tiene inventario autorizado y sus participantes, dominios, conceptos, artefactos y fuentes existen como referencias canónicas; no persiste relaciones globales nuevas.
