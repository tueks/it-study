...
| Estado del registro | B001–B025 `closed`; B026 `in-review` con inventario autorizado; B033–B042 inactivos. |
...
Obtener la aceptación editorial de B026 d1; después, promover, integrar, validar, reconciliar y cerrar sus cuatro comparaciones automáticamente.
...
- B026 tiene inventario autorizado y sus ocho entradas comparadas existen como fuentes canónicas `approved`; no persiste relaciones globales nuevas.
