...
| Entidades canónicas | 121 archivos: 51 `ideas-orientations`, 26 `people-capabilities`, 21 `ways-of-working`, 11 `solutions-structures`, 8 `specifications-implementations` y 4 `results-measurement`. |
