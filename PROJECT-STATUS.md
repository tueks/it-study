...
| Estado del registro | B001–B024 `closed`; B025 autorizado pero requiere inventario exacto; B033–B042 inactivos. |
...
Autorizar un inventario B025 exacto de cuatro comparaciones nuevas, con IDs, entradas comparadas, razones, dimensiones y fuentes; después, Codex podrá preparar B025 d1.
...
- B025 requiere un inventario exacto de cuatro comparaciones nuevas; no se seleccionan pares ni IDs por inferencia.
