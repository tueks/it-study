...
La autorización procede de la instrucción explícita del Responsable del proyecto del 2026-07-21 de ejecutar este lote conforme a su manifiesto autorizado `v1`. Este archivo transcribe el alcance autorizado para que su ejecución no dependa de la conversación.

## Alcance autorizado

| Campo | Valor |
|---|---|
| Declaración de alcance | Crear exclusivamente las doce fichas de dominio requeridas por `inventories/domains.yaml`, preservando significado, IDs, límites, vecinos y solapamientos de la taxonomía aprobada. |
...
| Tipos de contenido permitidos | `domain` |
...
| Dependencias de integración | Ninguna para producción; aceptación e integración quedan fuera de este encargo. |
...
| Criterios de exclusión | No crear subdominios, disciplinas, entidades, fuentes canónicas, comparaciones, escenarios, rutas, código, diseño ni derivados. |
...
| Efecto previsto sobre cobertura | De 0 a 12 fichas de dominio producidas; 0 aprobadas, aceptadas o integradas durante autoría. |
...
| Bloqueos | `none`: F0 y contratos requeridos constan aprobados. |
