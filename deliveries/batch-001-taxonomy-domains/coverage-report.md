...
| Alcance cubierto | Cobertura producida por las doce fichas de dominio. |
...
| Tipo de contenido distinto | 0 | 1 | 1 | 0 | 0 | 0 | 0 | 0 | 1 pendiente de revisión | `type: domain` |
...
| Fichas `domain` producidas | 12 | 12 | 12 | 12 | +12 | Cobertura exacta de los doce IDs. | Producción completa dentro de `v1`. |
