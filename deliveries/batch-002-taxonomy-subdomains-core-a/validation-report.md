...
| `validation-007` | Estados | 18 `draft`; lote `in-production` |
...
Limitaciones: no existe schema/CI autorizado y la precisión conceptual, suficiencia editorial y severidad requieren revisión independiente.
