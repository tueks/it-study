...
| Dimensión | Resultado |
|---|---|
| Alcance | 8/8 exactas; 0 extras y 0 modificaciones |
| Identidad | 8 IDs únicos; archivo=ID; 0 colisiones |
| Taxonomía | 8 hogares razonados; 64 aplicaciones; 0 pertenencia exclusiva múltiple |
| Estructura | Campos de disciplina presentes en 8/8 |
