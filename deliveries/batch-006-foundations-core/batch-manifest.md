# IT Study — Manifiesto de `batch-006-foundations-core`
...
| Inventario exacto | `inventories/batch-006-foundations-core.yaml` |
| Cantidad objetivo/máxima | 10/10 |
| Dependencias | B005 `closed`; taxonomía 48/12 canónica; satisfechas. Dependencias internas ordenadas. |
| Inclusión | Diez fundamentos, clasificación autorizada, ejemplos, límites, fuentes y cuatro dependencias `requires`. |
